...
module.exports = function(app) {
    ...
    app.post('/submit', (req, res) => {
        ...
        res.json({ firstInstallmentFee, schoolFee, duration });
    });
    ...
    app.get('/verifyPay', (req, res) => {
        ...
        db.query(getAdmissionNumberQuery, [emailAddress], (err, result) => {
            ...
            if (result.length === 1) {
                const existingAdmissionNumber = result[0].admissionNumber;
                ...
                db.query(updateQuery, [firstPayreferenceNumber, existingAdmissionNumber, existingAdmissionNumber, existingAdmissionNumber], (updateErr, updateResult) => {
                    ...
                    if (updateResult.affectedRows === 1) {
                        const paymentMessage = `Dear ${firstName}, Your payment for the first installment fee of ${firstInstallmentFee} with reference number ${firstPayreferenceNumber} has been verified successfully! Please check your email for the payment receipt download. Kindly keep it for your records.

For your login:
Username: ${existingAdmissionNumber}
Password: ${existingAdmissionNumber}

For security reasons, please login using the provided username and password, and then immediately click on 'Forgot Password' on the login page to change your password to something secure and memorable. Thank you!`;
                        res.send(`
                            <!DOCTYPE html>
                            <html lang="en">
                            <head>
